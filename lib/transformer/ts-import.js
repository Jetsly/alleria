...
function createDistAst(struct, options) {
    ...
    try {
        ...
        var scriptNode = ts.createImportDeclaration(undefined, undefined, ts.createImportClause(struct.variableName || !options.transformToDefaultImport
            ? undefined
...
function createTransformer(_options) {
    ...
    var mergeDefault = function (options) { return (__assign({}, defaultOptions, options)); };
